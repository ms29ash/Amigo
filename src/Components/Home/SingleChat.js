...
function SingleChat({ chat }) {
    ...
    return (
        <>
            <div className="flex   cursor-pointer hover:text-black px-4 py-3 hover:bg-green  items-center group w-full relative  max-w-full"  >
                <img
                ...
                <div className=" relative w-[70%] flex flex-row items-center ">
                    ...
                    <div className=" right-0 top-0 bottom-0 absolute flex flex-col items-end  justify-center text-sm  w-[30%] z-10  ">
                        ...
                        <p className="text-xs" >
                            {chat.latestMsg && <><TimeDifference date={chat?.latestMsg?.updatedAt} /> ago</>}</p>
                    </div>
